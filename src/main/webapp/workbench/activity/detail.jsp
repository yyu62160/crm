...
<script type="text/javascript">
	...
	function deleteRemark(id){
		$.ajax({
			...
			success:function (data){
				 ...
				 */
				if(data.sucess){
					//showRemarkList();这种方式不行，因为使用的是before方法，每一次删除之后，页面上都会保留原有的数据
    ...
    function editRemark(id){
	    ...
	    //将模态窗口中，给隐藏域中的remarkId 赋值
        $("#remarkId").val(id);
	    //找到指定的存放备注信息的h5标签
        var noteContent = $("#e"+id).html();
        //将h5中展现出来的信息，赋予到修改操作的模态窗口内容里面
