...
<body>
	...
	<form action="tran/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="买瓜123a">
				<input type="hidden" name="activityId" value="21f58b5d80634b8f815ff3bab09fda36">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="张二蛋">
				<input type="hidden" name="contactsId" value="3f2445169f9f4b7e8b8a0af4ef89fefc">
			</div>
		</div>
